...
import { industryContext } from "../context/IndustryContent";
...
const IndustryPage = () => {
  ...
  const titles = navTitle.Industries?.subTitle || []; // Get subtitles for the "Service" section
  const { industryData } = useContext(industryContext); // Get service data
