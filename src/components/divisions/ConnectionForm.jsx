  ...
  const submitFormData = (e) => {
    ...
    emailjs
      .send(
        ...
        "template_gkj6hi3", // Replace with EmailJS Template ID
        formData,
            ...
            <div className="w-full mt-8">
              <div className="mx-auto max-w-md flex flex-col gap-6">
                ...
                <textarea
                  ...
                  onChange={(e) => handleChange(e)}
                />
                <button onClick={submitFormData} className="mt-5 tracking-wide font-semibold bg-blue-900 text-white w-full py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out focus:ring-2 focus:ring-indigo-700 focus:outline-none">
                  Submit
                </button>
              </div>
            </div>
